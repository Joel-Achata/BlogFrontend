        ...
        <div class="row px-4">
            <div class="col-12">
                ...
                <div class="d-flex">
                    ...
                    <p class="mr-3 text-muted"><i class="fa fa-folder"></i> {{ (post.categoria) ? post.categoria.nombre
                        : '' }}</p>
            ...
            <div class="col-12 py-4">
                <div class="btn-group btn-group-lg w-100">
                    <button @click="cambiarPost('anterior')" type="button" class="btn btn-outline-primary"><i
                            class="fa fa-angle-left mr-2"></i>
                        Anterior
                    </button>
                    <button @click="cambiarPost('siguiente')" type="button" class="btn btn-outline-primary">Siguiente<i
            ...
            <div class="col-12 py-4">
                ...
                <div v-for="coment in post.comentarios" :key="coment" class="media mb-4">
                    <img :src="'https://ui-avatars.com/api/?name=' + coment.usuario.name + '&background=0D8ABC&color=fff'"
            ...
            <div v-if="token" class="col-12">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="button" @click="enviarComentario()" class="btn btn-primary">Enviar
                            comentario</button>
                    </div>
                </div>
            </div>
...
export default {
    setup() {
        ...
        const cambiarPost = async (param) => { //para puede ser anterior o siguiente 
            try {
