                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex text-white">
                            ...
                            <small class="mr-2"><i class="fa fa-comments"></i> {{ slide.cant_comentarios }}
                                Comentarios</small>
                        </div>
                        <!-- <a href="#" class="btn btn-lg btn-outline-light mt-4">Leer mas</a> -->
                        <RouterLink :to="'/vermas/' + slide.id" class="btn btn-lg btn-outline-light mt-4">Leer mas
                        </RouterLink>
                    </div>
                </div>
            </slide>
        ...
        <div v-for="item in posts" :key="item.id" class="row blog-item px-3 pb-5">
            ...
            <div class="col-md-7">
                ...
                <div class="d-flex mb-3">
                    ...
                    <small class="mr-2 text-muted"><i class="fa fa-comments"></i>{{ item.cant_comentarios }} Comentarios
                    </small>
                </div>
                <p>
                    {{ item.resumen }}
                </p>
                <!-- <a class="btn btn-link p-0" href="#">Leer mas<i class="fa fa-angle-right"></i></a> -->
                <RouterLink :to="'/vermas/' + item.id" class="btn btn-link p-0">Ver mas <i
                        class="fa fa-angle-right"></i>
                </RouterLink>
            </div>
        </div>
    </div>
    <div v-else class="container bg-white p-5">
    ...
    setup() {
        ...
        const obtenerDatos = async () => {
            ...
            try {
                ...
                slides.value = data.paraSlaider;
                console.log(data.paraSlaider);
                loading.value = false;
            } catch (error) {
                console.log(error);
            }
